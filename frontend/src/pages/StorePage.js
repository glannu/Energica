    ...
    <main className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <footer className="mt-16 border-t border-neutral-200 pt-8 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <img src="/glannu-logo.png" alt="Glannu" className="h-10 mb-3" />
            <p className="text-sm text-neutral-500 leading-relaxed">Glannu, Pune. Trusted distributor of solar PV system components and BOS materials.</p>
          </div>
          <div>
